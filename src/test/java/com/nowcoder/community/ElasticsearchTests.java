...
public class ElasticsearchTests {
    ...
    // NoNodeAvailableException[None of the configured nodes are available: [{#transport#-1}{q1Wsz4-MQeqXj2IhELau-Q}{127.0.0.1}{127.0.0.1:9300}]
    //]
    @Test
...
//                .withPageable(PageRequest.of(0, 10))  //构建分页条件， of的参数表示第几页，显示多少条
//                .withHighlightFields( // 指定哪些字段哪些词高亮显示
...
//        System.out.println(page.getTotalElements());  // 一共多少条数据匹配
...
//    }
    ...
    @Test
    public void testSearchByTemplate() { //利用template做搜索,让返回数据高亮显示
        ...
        Page<DiscussPost> page = elasticTemplate.queryForPage(searchQuery, DiscussPost.class, new SearchResultMapper() {
            ...
            public <T> AggregatedPage<T> mapResults(SearchResponse response, Class<T> aClass, Pageable pageable) {
                ...
                for (SearchHit hit : hits) {
                    ...
                    post.setCreateTime(new Date(Long.valueOf(createTime)));  //将long类型的转换
                    ...
                    if (titleField != null) {
                        // 把之前的title覆盖掉, 由于title中匹配的词条可能是多个,设置的title中主要第一段高亮词
        ...
        for (DiscussPost post : page) {
            System.out.println(post);  //返回的结果是能匹配上的那一小段内容
        }
    }
