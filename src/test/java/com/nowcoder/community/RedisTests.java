...
public class RedisTests {
    ...
    public void testOrderSet(){
        ...
        redisTemplate.opsForZSet().add(redisKey,"关羽", 20);
        redisTemplate.opsForZSet().add(redisKey,"张飞", 60);
        redisTemplate.opsForZSet().add(redisKey,"赵云", 30);
